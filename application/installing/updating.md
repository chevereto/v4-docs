...
When using Docker it will required to re-build the Chevereto image ([make image](https://github.com/chevereto/docker/blob/4.4/docs/BUILDING.md) or [docker build](https://github.com/chevereto/docker/blob/4.4/docs/PURE-DOCKER.md)) and then re-start the containers.

Refer to [UPDATING](https://github.com/chevereto/docker/blob/4.4/docs/UPDATING.md) for instructions.
...
* Run [CLI update](../reference/cli.md#database-migrate) `app/bin/cli -C database-migrate`
