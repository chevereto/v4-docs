...
```sh
/usr/local/bin/ea-php82 /home/chevereto/public_html/app/bin/cli -C cron >/dev/null 2>&1
```
</code-block>

<code-block title="CloudLinux">
```sh
/opt/alt/php82/usr/bin/php /home/chevereto/public_html/app/bin/cli -C cron >/dev/null 2>&1
```
</code-block>
</code-group>
