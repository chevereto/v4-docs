...
With the [API V1.1](api-../../developer/api/api-v1.md) users can interact with Chevereto from another system, i.e. to upload screenshots using [ShareX](https://v4-user.chevereto.com/integrations/sharex.html) directly to the user's account.
