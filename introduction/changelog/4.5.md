...
Use this to define the database isolation mode for tenants, which can be either `database` (each tenant has its own database) or `prefix` (tenants share a database with table name prefixes).
