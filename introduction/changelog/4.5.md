...
* [4.5.3](https://releases.chevereto.com/4.X/4.5/4.5.3.html)
* [4.5.4](https://releases.chevereto.com/4.X/4.5/4.5.4.html)
* [4.5.5](https://releases.chevereto.com/4.X/4.5/4.5.5.html)
* [4.5.6](https://releases.chevereto.com/4.X/4.5/4.5.6.html)
* [4.5.7](https://releases.chevereto.com/4.X/4.5/4.5.7.html)
...
`CHEVERETO_TENANTS_DB_ISOLATION_MODE`

Use this to define the database isolation mode for tenants, which can be either `database` (each tenant has its own database) or `table` (tenants share a database with table name prefixes).

`CHEVERETO_PROVIDER_SUPPORT_URL`

This variable is required in `CHEVERETO_CONTEXT=saas` setups to specify the service provider support URL for the Chevereto instance.

`CHEVERETO_PROVIDER_DOCS_URL`

This variable is required in `CHEVERETO_CONTEXT=saas` setups to specify the service provider documentation URL for the Chevereto instance.
...
Contact page has been redesigned to be more user-friendly and visually appealing, without the burden of a form.
